...
const props = defineProps({
  cardList: { type: Object as PropType<any> },
  valueCards: { type: Array, default: [], required: true },
});
...
function isBlack(type: string) {
  return type === "s" || type === "c";
}

function map(card: string) {
  return mapCard(card);
}

function shadow(card: string) {
